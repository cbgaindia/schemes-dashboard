...
class GraphComponent extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState){ 
      ...
      if(prevState.value != this.state.value || prevState.budgetAttr != this.props.budgetAttr || prevProps.data != this.props.data || prevProps.schemeData != this.props.schemeData ){
...
render (){
    ...
    return(
     <div className="vis-wrapper">
        <div className="">
              <div className="">
                <Select isMulti={true} simpleValue value={this.state.value} placeholder="Select a State" options={this.state.stateOptions} onChange={this.handleSelectChange} />
              </div>
